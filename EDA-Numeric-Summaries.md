...
![](EDA-Numeric-Summaries_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](EDA-Numeric-Summaries_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
how to pivot wider function and set it like an actual table rather than
a data frame visual
